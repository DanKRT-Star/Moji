...
const ChatCard = ({
  ...
  return (
    <Card
        key={convoId}
        className={cn("broder-none p-3 cursor-pointer transition-smooth glass hover:bg-muted/30",
        ...
        <div className="flex items-center gap-3">
            ...
            <div className="flex-1 min-w-8">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <MoreHorizontal className="size-4 text-muted-foreground opacity-0 group-hover:opactity-100 hover:size-5 transition-smooth"/>
                </div>
            </div>
        </div>
