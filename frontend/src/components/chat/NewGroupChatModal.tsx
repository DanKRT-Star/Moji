...
const NewGroupChatModal = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    try {
      ...
      console.error("Lỗi xảy ra khi handle submit:", error)
    }
  }

  const filteredFriends = friends.filter((friend) => friend.displayName.toLocaleLowerCase().
  includes(search.toLocaleLowerCase()) && !invitedUsers.some((u) => u._id === friend._id))
